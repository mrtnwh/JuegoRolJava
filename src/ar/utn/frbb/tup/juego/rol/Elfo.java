...
public class Elfo extends Personaje {
    ...
    public Elfo(String raza, String nombre, String apodo, String fechaNac, int edad, int salud, int velocidad, int destreza, int fuerza, int nivel, int armadura) {
    ...
    public static double Ataque(double ValorAtaque, double EfectividadDisparo){
        double v = (((ValorAtaque * EfectividadDisparo) / 500) * 100) * 1.05;
        return v;
    };
